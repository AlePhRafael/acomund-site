...
const pages: Record<string, { title: string; intro: string; items: string[] }> = {
  ...
  contato: { title: "Fale com a equipe Açomund.", intro: "Envie sua necessidade e retornaremos com os próximos passos. Os dados comerciais abaixo são placeholders.", items: ["Telefone: [placeholder]", "E-mail: [placeholder]", "Atendimento técnico: [placeholder]"] },
